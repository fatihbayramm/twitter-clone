...
export default function Premium() {
  return (
    <section className="max-w-[348px] bg-[color:var(--background-secondary)] mb-4 rounded-2xl border border-[color:var(--background-secondary)] py-3 px-4 flex flex-col gap-2.5">
