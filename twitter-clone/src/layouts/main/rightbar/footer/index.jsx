    ...
    <footer className="mb-4 px-4 flex flex-wrap gap-2">
      ...
      <div className="w-full flex gap-2">
        <Popover className="relative inline-flex leading-4">
          ...
          <PopoverPanel className="w-[15-px] max-w-[384px] bg-[color:var(--background-primary)] shadow-box rounded-xl absolute right-0 bottom-0 grid overflow-hidden">
            <Link
              to="/"
