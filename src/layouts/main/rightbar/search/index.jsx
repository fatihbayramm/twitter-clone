...
export default function Search() {
  ...
  return (
    <div
      ref={ref}
      className="min-h-[32px] w-[350px] h-[53px] mb-3 flex items-center sticky top-0 bg-[color:var(--background-primary)] z-10"
    >
      ...
      {focus && (
        <div className="absolute w-[350px] top-full -left-px -translate-y-1 w-full bg-[color:var(--background-primary)] shadow-box max-h-[calc(80vh-53px)] rounded-lg text-center min-h-[100px]">
